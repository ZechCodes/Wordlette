...
class Router:
    ...
    def add_route(self, path_or_route: "str | Type[wordlette.routes.Route]", **kwargs):
        match path_or_route:
            ...
            case wordlette.core.routes.Route.matches_type() as route_type:
    ...
    def url_for(self, route: "type[wordlette.core.routes.Route]", **path_params) -> str:
    ...
    def _add_route_type(
        self,
        route_type: "Type[wordlette.core.routes.Route]",
        include_in_schema: bool = True,
    ):
